...
function ContentProduct() {
  ...
  const insuranceFee = 125000;

  // Số ngày thuê, có thể thay đổi theo nhu cầu của bạn
  const numberOfDays = 1; // Số ngày thuê

  // Tính tổng tiền
  const totalCost = carPricePerDay * numberOfDays + serviceFee + insuranceFee;
        ...
        <div className="contentproduct__detail">
          <div className="contentproduct__detail-container">
                    ...
                    <p className="df-align-center">
                      ...
                      <span className="tooltip">
                        ...
                        <span className="df-align-center-tooltip-text">
                          ...
                          chuyến đi, bạn vui lòng đổ xăng về lại mức ban đầu như
                          khi nhận xe
                        </span>
                      </span>
                    </p>
                  ...
                  <div className="price-item">
                    <p className="df-align-center">
                      ...
                      <span className="tooltip">
                        ...
                        <span className="df-align-center-tooltip-text">
                          Phí dịch vụ giúp chúng tôi duy trì và phát triển dịch
                          vụ trên ưng dụng Mioto
                        </span>
                      </span>
                    </p>
                    <p className="cost">
                    ...
                    <p className="df-align-center">
                      ...
                      <span className="tooltip">
                        ...
                        <span className="df-align-center-tooltip-text">
                          ...
                          tô. Trường hợp có sự cố ngoài ý muốn (trong phạm vi
                          bảo hiểm), số tiền bạn thanh toán tối đa là 2.000.000
                      ...
                      <div className="surcharge-item-content">
                        ...
                        <div className="surcharge-item-contnent-item">
                          <p>
                            ...
                            hợp trễ quá 5 tiếng, phụ phí thêm 1 ngày thuê
                          </p>
                        </div>
                      </div>
                    </div>
            ...
            <div className="contentproduct__detail-container-content">
              ...
              <form
                className="contentproduct__evaluate"
              ...
              >
                ...
                <button
                  type="submit"
                  className="contentproduct__evaluate-button"
                >
                  Gửi
                </button>
              </form>
                      ...
                      <div className="list-reviews-item-name" key={index}>
                        ...
                        <div
                          className={`list-reviews-item-name-cmt ${
                            showFullComment ? "full-comment" : ""
                          }`}
                        >
                          <h3>{review.reviewText}</h3>
                          {!showFullComment && (
                            <div className="show-more" onClick={toggleComment}>
                              ...
                            </div>
                          )}
                        </div>
        ...
        <div className="contentproduct__other">
          ...
          <Slider {...car__slider}>
            {similarCars.map((similarCar) => (
              <Link
                to={`/product/${similarCar._id}`}
                className="content__list-child"
                key={similarCar._id}
              >
                <div
                  key={similarCar._id}
                  className="contentproduct__other-child"
                >
